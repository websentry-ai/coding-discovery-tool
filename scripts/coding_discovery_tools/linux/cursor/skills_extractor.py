...
class LinuxCursorSkillsExtractor(BaseCursorSkillsExtractor):
    ...
    def extract_all_skills(self, plugin_lookup: Optional[Dict] = None) -> Dict:
        ...
        self._extract_project_level_skills(projects_by_root, plugin_lookup=plugin_lookup)
    ...
    def _extract_user_level_skills(
        self, user_skills: List[Dict], plugin_lookup: Optional[Dict] = None
    ) -> None:
    ...
    def _extract_project_level_skills(
        self, projects_by_root: Dict[str, List[Dict]], plugin_lookup: Optional[Dict] = None
    ) -> None:
        for user_home in get_linux_user_homes():
            try:
                self._walk_for_skills(
