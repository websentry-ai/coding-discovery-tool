"""Gemini CLI skills extraction for Linux systems."""
...
class LinuxGeminiCliSkillsExtractor(BaseGeminiCliSkillsExtractor):
    """Extractor for Gemini CLI skills on Linux systems."""
