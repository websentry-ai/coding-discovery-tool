"""MCP config extraction for Kilo Code on Linux systems."""
...
class LinuxKiloCodeMCPConfigExtractor(BaseMCPConfigExtractor):
    ...
    def _extract_global_configs_for_user(self, user_home: Path) -> List[Dict]:
        ...
        for ide_name in self.IDE_NAMES:
            config_path = (
                ...
                / self.KILOCODE_EXTENSION_ID / "settings" / "mcp_settings.json"
            )
