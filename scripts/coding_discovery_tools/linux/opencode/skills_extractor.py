"""OpenCode skills extraction for Linux systems."""
...
class LinuxOpenCodeSkillsExtractor(BaseOpenCodeSkillsExtractor):
    """Extractor for OpenCode skills on Linux systems."""
