"""
MCP config extraction for Cursor CLI on macOS systems.
...
class MacOSCursorCliMCPConfigExtractor(BaseMCPConfigExtractor):
    """
    Extractor for Cursor CLI MCP config on macOS systems.
    ...
    def extract_mcp_config(self) -> Optional[Dict]:
        """
        Extract Cursor CLI MCP configuration on macOS.
