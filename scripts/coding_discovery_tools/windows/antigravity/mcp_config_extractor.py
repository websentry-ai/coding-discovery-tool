"""
MCP config extraction for Antigravity on Windows systems.
"""
...
class WindowsAntigravityMCPConfigExtractor(BaseMCPConfigExtractor):
    """Extractor for Antigravity MCP config on Windows systems."""

    GLOBAL_MCP_CONFIG_PATH = Path.home() / ".gemini" / "antigravity" / "mcp_config.json"

    def extract_mcp_config(self) -> Optional[Dict]:
        """
        Extract Antigravity MCP configuration on Windows.
