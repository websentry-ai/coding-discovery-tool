    ...
    def _extract_project_level_rules(self, root_path: Path, projects_by_root: Dict[str, List[Dict]]) -> None:
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=4) as executor:
                futures = {
                    executor.submit(self._walk_for_clinerules_directories, root_path, dir_path, projects_by_root, current_depth=1)
            ...
            self._walk_for_clinerules_directories(root_path, root_path, projects_by_root, current_depth=0)
