"""
Kilo Code skills extraction for Windows systems.

Extracts Kilo Code skills from all projects, grouping them by project root.

Global skills:  ~/.kilo/skills, ~/.agents/skills
Project skills: **/.kilo/skills, **/.agents/skills, **/.claude/skills (compat)
"""
...
class WindowsKiloCodeSkillsExtractor(BaseKiloCodeSkillsExtractor):
    """Extractor for Kilo Code skills on Windows systems."""
    ...
    def extract_all_skills(self) -> Dict:
        """
        Extract all Kilo Code skills from all projects on Windows.
        ...
        logger.info(f"Searching for Kilo Code skills from root: {root_path}")
    ...
    def _extract_user_level_skills(self, user_skills: List[Dict]) -> None:
        """Extract user-level skills from ~/.kilo/skills/ for each user."""
