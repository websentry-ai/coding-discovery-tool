...
class TestCopilotCliFactoryWiring(unittest.TestCase):
    ...
    def test_detector_none_on_non_darwin(self):
        self.assertIsNone(ToolDetectorFactory.create_copilot_cli_detector("Windows"))
    ...
    def test_extractor_none_on_non_darwin(self):
        self.assertIsNone(CopilotCliMCPConfigExtractorFactory.create("Windows"))
